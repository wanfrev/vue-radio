...
<template>
  <section class="flex flex-col items-center justify-center min-h-[100dvh] gap-8 px-4 pt-14 pb-8">
    <!-- Logo -->
    <img
      :src="logoUrl"
      alt="AireMedia"
      class="w-auto max-h-[55vh] max-w-[95vw] object-contain drop-shadow-[0_0_80px_rgba(34,211,238,0.7)]"
    />

    <!-- Volume -->
    <div class="flex items-center gap-2.5 px-4 py-2.5 rounded-full bg-slate-900/80 border border-slate-800 w-48">
